Bivariate data is data involving two variables, where each value of one variable is paired with a value of the other variable. Bivariate data can occur in two forms:

If for $1\leq i\leq k$ there are $n_{i}$ choices for the $i$th item in the list regardless of previous choices, then the number of possible lists is $n_{1\times}n_{2}\times\dots \times n_{k}$
## Example

If $a_{n}$ and $b_{n}$ are [[Sequences]] of real numbers where $a_{n}$ [[Convergence|converges]] to 0 and $\left| b_{n} \right|\leq \left| a_{n} \right|,\forall n\in\mathbb{N}$ then $b_{n}$ converges to 0
## Proof

Every [[Groups|group]] $G$ is isomorphic to a subgroup of the symmetric group acting on $G$, $Sym(G)$ whose elements are the [[Git?/Mathematics/Pure/Group Theory/Permutations]] of the underlying set of $G$

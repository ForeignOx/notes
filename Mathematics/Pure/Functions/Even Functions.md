We say that a [[Real Functions|function]] $f$ is even if we always have $f(x)=f(-x)\forall x\in \text{Dom}f$. This means that its graph has reflectional symmetry around $x=0$

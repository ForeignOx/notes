The graph of $f$ (where $f$ is a real valued [[Functions|function]] of a single real variable) is the set of all points $(x,y)\in\mathbb{R}^2$ such that $x\in \text{Dom}f$, $y=f(x)$

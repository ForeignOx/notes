The graph of a [[Real Functions|function]] $f:\mathbb{R}\to \mathbb{R}$ can be shifted, reflected and rescaled by applying some simple transformations to the function and its argument, as follows:
## Translation

The eigenspace $V_{\lambda}$ corresponding to an [[Eigenvalues|eigenvalue]] $\lambda$ is the [[Real Vectorspaces|vector]] [[Subspaces|subspace]] [[Span|spanned]] by the respective [[Eigenvectors|eigenvectors]] 
$$
